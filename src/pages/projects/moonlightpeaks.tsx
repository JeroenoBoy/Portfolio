    ...
    return (
        <Project>
            <ProjectHeader>
                ...
                <p>
                    During my internship at Little Chicken Game Company, I have created many features, written some
                    of the core systems and assistet with many more parts of the game. Some of these include the
                    spell casting, the interaction system, critters the cute kitty cat and much more.
                </p>
            </ProjectHeader>
            <ProjectSidebar>
